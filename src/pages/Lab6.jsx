...
const Lab6 = () => {
    ...
    return (
        <div className="lab6-container">
            ...
            <p>
                — Реализованы запросы GET, POST, DELETE для работы с отзывами через Redux.<br />
                — Использованы формы для отправки данных на сервер (форма обратной связи).<br />
                — Добавлена возможность редактирования профиля пользователя.<br />
                — Выведены отзывы с использованием GET запроса.<br />
                — Реализована возможность удаления отзывов.<br />
                — Все состояния и действия оптимизированы с помощью Redux.
            </p>
